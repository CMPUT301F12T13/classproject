...
/**
 * AudioViewActivity is the activity that allows the user
 * view a audio fulfillment.
 * This activity should be launched with an intent created
 * by {@link FulfillmentViewIntentFactory}.
 */
public class AudioViewActivity extends FulfillmentViewActivity implements OnClickListener {
