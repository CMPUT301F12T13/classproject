...
/**
 * TextViewActivity is the activity that allows the user
 * view a text fulfillment.
 * This activity should be launched with an intent created
 * by {@link FulfillmentViewIntentFactory}.
 */
public class TextViewActivity extends FulfillmentViewActivity implements OnClickListener {
